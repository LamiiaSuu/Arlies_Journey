...
public class CollisionChecker {
    ...
    public static boolean checkCollision(ImageView image1, ImageView image2, String obstacleType, GraphicsContext gc, boolean hitBoxVisible) {
...
//    	gc.clearRect(centerX-100, centerY-100, centerX+100, centerY+100);
    ...
    private static void drawCircleObstacles(double centerX, double centerY, double radius, GraphicsContext gc, String obstacleType) {
